...
class Staff(Employee):
    ...
    meetings = models.ManyToManyField('Meeting', through='Staff_Meeting',blank=True)
...
class FacultyMember(Employee):
    ...
    meetings = models.ManyToManyField('Meeting', through='FacultyMember_Meeting',blank=True)
...
class Meeting(models.Model):
    ...
    faculty_members = models.ForeignKey("FacultyMember", on_delete=models.CASCADE)
    staff_members = models.ForeignKey("Staff", on_delete=models.CASCADE)
...
class Committee(models.Model):
    ...
    comments = models.TextField(max_length=255)
    headed_by = models.ForeignKey(Employee, on_delete=models.CASCADE)
    record_created_at = models.DateTimeField(auto_now_add=True)
    record_updated_at = models.DateTimeField(auto_now=True)
...
class Staff_Meeting(models.Model):
    staff = models.ForeignKey(Staff, on_delete=models.CASCADE)
    meeting = models.ForeignKey(Meeting, on_delete=models.CASCADE)
    def __str__(self):
           """String for representing the Faculty object (in Admin site etc.)."""
...
class Decision(models.Model):
    offender_student = models.ForeignKey(Offender, on_delete=models.CASCADE)
...
class Meeting_Decision(models.Model):
    ...
    def __str__(self):
        """String for representing the Meeting object (in Admin site etc.)."""
        return self.meeting + " " + self.decision
